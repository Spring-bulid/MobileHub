...
object Octicons {
    ...
    val Sun: ImageVector
        get() = icon(
            "sun",
            "M8 2.5 A0.75 0.75 0 0 1 8.75 3.25 V4.75 A0.75 0.75 0 0 1 7.25 4.75 V3.25 A0.75 0.75 0 0 1 8 2.5 Z M8 11.25 A0.75 0.75 0 0 1 8.75 12 V13.5 A0.75 0.75 0 0 1 7.25 13.5 V12 A0.75 0.75 0 0 1 8 11.25 Z M2.5 8 A0.75 0.75 0 0 1 3.25 7.25 H4.75 A0.75 0.75 0 0 1 4.75 8.75 H3.25 A0.75 0.75 0 0 1 2.5 8 Z M11.25 8 A0.75 0.75 0 0 1 12 7.25 H13.5 A0.75 0.75 0 0 1 13.5 8.75 H12 A0.75 0.75 0 0 1 11.25 8 Z M4.4 4.4 A0.75 0.75 0 0 1 5.46 4.4 L6.52 5.46 A0.75 0.75 0 0 1 5.46 6.52 L4.4 5.46 A0.75 0.75 0 0 1 4.4 4.4 Z M9.48 10.54 A0.75 0.75 0 0 1 10.54 10.54 L11.6 11.6 A0.75 0.75 0 0 1 10.54 12.66 L9.48 11.6 A0.75 0.75 0 0 1 9.48 10.54 Z M5.46 9.48 A0.75 0.75 0 0 1 5.46 10.54 L4.4 11.6 A0.75 0.75 0 0 1 3.34 10.54 L4.4 9.48 A0.75 0.75 0 0 1 5.46 9.48 Z M11.6 4.4 A0.75 0.75 0 0 1 12.66 5.46 L11.6 6.52 A0.75 0.75 0 0 1 10.54 5.46 L11.6 4.4 A0.75 0.75 0 0 1 11.6 4.4 Z M8 5.5 A2.5 2.5 0 1 1 5.5 8 A2.5 2.5 0 0 1 8 5.5 Z"
        )

    val Moon: ImageVector
        get() = icon(
            "moon",
            "M7.5 1 A7 7 0 1 0 15 8.5 A5.5 5.5 0 0 1 7.5 1 Z M9 2.59 A4.5 4.5 0 0 0 13.41 7 A6 6 0 0 1 9 2.59 Z"
        )

    val Sync: ImageVector
        get() = icon(
            "sync",
            "M1.5 2.75 A0.75 0.75 0 0 1 2.25 2 H5 V3.5 H2.75 V5.5 H2 Z M4.72 3.28 A5.5 5.5 0 0 1 13 5.5 H11.5 A4 4 0 0 0 5.78 4.78 Z M13.81 12.96 A0.75 0.75 0 0 1 13.25 14 H11 V12.5 H13.25 V10.5 H14 Z M11.28 12.72 A5.5 5.5 0 0 1 3 10.5 H4.5 A4 4 0 0 0 10.22 11.22 Z"
        )

    val Layout: ImageVector
        get() = icon(
            "layout",
            "M2 2.75 A0.75 0.75 0 0 1 2.75 2 H6.5 V7.25 H2 Z M2 8.75 V13.25 A0.75 0.75 0 0 0 2.75 14 H6.5 V8.75 Z M8 2 H13.25 A0.75 0.75 0 0 1 14 2.75 V6.5 H8 Z M8 8 V14 H13.25 A0.75 0.75 0 0 0 14 13.25 V8 Z"
        )
    }
